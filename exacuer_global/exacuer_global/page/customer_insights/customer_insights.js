frappe.pages['customer-insights'].on_page_load = function(wrapper) {
    ...
    function fetch_customer_insights() {
        ...
        frappe.call({
            method: 'exacuer_global.exacuer_global.page.customer_insights.customer_insights.get_customer_insights',
            args: { filters },
			freeze: true,
	...
	function open_customer_details(customer_code, doctype_name, details) {
		frappe.call({
			method: 'exacuer_global.exacuer_global.page.customer_insights.customer_insights.get_customer_details',
			args: {
