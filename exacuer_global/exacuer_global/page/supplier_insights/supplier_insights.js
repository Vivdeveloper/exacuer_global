frappe.pages['supplier-insights'].on_page_load = function(wrapper) {
    ...
    function fetch_supplier_insights() {
        ...
        frappe.call({
            method: 'exacuer_global.exacuer_global.page.supplier_insights.supplier_insights.get_supplier_insights',
            args: { filters },
			freeze: true,
	...
	function open_supplier_details(supplier_code, doctype_name, details) {
		frappe.call({
			method: 'exacuer_global.exacuer_global.page.supplier_insights.supplier_insights.get_supplier_details',
			args: {
